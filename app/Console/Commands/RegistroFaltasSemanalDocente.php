...
class RegistroFaltasSemanalDocente extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'faltas:semanaldocente';
    ...
    {
        // obtener horarios con rol 3 (docente)
        $horarios = HorarioClase::where('Horario_clase.rol_id', '=', 3)
                            ->get()->groupBy('dia');
