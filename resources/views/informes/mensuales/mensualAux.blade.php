    ...
    <div class="m-3">
        <div class="container-fluid">
            ...
            @if (!$asistencias->isEmpty())
                ...
                <table class="table table-bordered table-responsive" id="table-todos">
                    <tr>
            ...
            @if (!$asistenciasDoc->isEmpty())
                {{-- <h4 class="textoBlanco">{{ $unidad[0]->unidad->facultad }} /
                    {{ $unidad[0]->unidad->nombre }}</h4> --}}
                <table class="table table-bordered table-responsive" id="table-doc">
            ...
            @if (!$asistenciasLabo->isEmpty())
                {{-- <h4 class="textoBlanco">{{ $unidad[0]->unidad->facultad }} /
                    {{ $unidad[0]->unidad->nombre }}</h4> --}}
                <table class="table table-bordered table-responsive" id="table-labo">
