        ...
        <div class="container-fluid">
            ...
            {{-- @csrf
                <form  method="POST"  @yield('action') onsubmit= "return valMinAct()"> --}}
                    @yield('reporte')
                    {{-- </form>       --}}
            <button class="btn boton float-right" id="registrar">OBTENER PDF  <svg style="padding-bottom: 0.1em" width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-file-earmark-text" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
