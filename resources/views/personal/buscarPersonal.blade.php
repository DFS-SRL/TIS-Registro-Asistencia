...
<div class="container">
    <div class="mx-3 my-4">
        <div class="row">
            ...
            <div class="col-md-5">
                <form class="form-inline my-2 my-lg-0" method="POST" action="{{ route('personalAcademico.buscar', $unidad) }}" onsubmit="return (validarSoloLetras('buscador', 'mensaje') && validarNoVacio('buscador'))">
