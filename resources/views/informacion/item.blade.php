    ...
    <div class="mx-3 my-4">
        <div class="container">
            <div class="row">
                ...
                <div class="col-4">
                    <button type="button" class="btn boton my-3" onclick="editarGrupo({{$item->id}});">editar  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
