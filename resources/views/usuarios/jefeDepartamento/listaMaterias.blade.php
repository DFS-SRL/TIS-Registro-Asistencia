...
<body>
    <div class="mx-3 my-4">
        <div class="row">
            ...
            <div class="col-md">
                <span class="textoBlanco"></span><button type="button" class="btn boton ml-2" >añadir materia   <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-plus-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
