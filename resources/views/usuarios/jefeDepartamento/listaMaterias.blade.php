...
<body>
    <div class="mx-3 my-4">
        <div class="row">
            ...
            <div class="col-md">
                <span>añadir materia</span><button type="button" class="btn btn-primary ml-2" ><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-plus-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="container mt-5">
            <ul class="list-group">
                @forelse ($materias as $materia)
                    <li class="list-group-item"><a href="">{{$materia->nombre}}</a></li>
                @empty
                    <h3>Este unidad no tiene materias asignadas</h3>
                @endforelse
                <div class="mt-3">
                    {{$materias->links()}}
                </div>
